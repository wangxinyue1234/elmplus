...
public class 连接数据库步骤演示 {
    ...
    public static void change(Integer argId){
        ...
        try{
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3310/llg?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true","root","111111");
...
//            回显数据到控制台
    ...
    public static void add() throws Exception {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3310/llg?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true","root","111111");
